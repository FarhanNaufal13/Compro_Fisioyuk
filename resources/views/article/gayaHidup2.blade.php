    ...
    <section class="post-header py-5 ">
      <div class="custom-shape-divider-bottom-1669716349">
        ...
        <div class="header-content post-container">
            ...
            <h1 class="header-title"> FISIOTERAPI POTENSI KARIR YANG UNIK, INOVATIF, DAN PENUH MANFAAT</h1>
            <img src="../assets/img/Informasi/gaya hidup 2.jpg" alt="" class="header-img shadow">
    </div>
