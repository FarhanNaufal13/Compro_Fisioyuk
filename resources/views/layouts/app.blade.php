...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Fisioyuk Admin</span>
    </a>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="/admin/bannerHome" class="nav-link ">
                  <i class="far nav-icon fa-circle"></i>
                  <p>Data Banner Home</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="/admin/bannerPromo" class="nav-link ">
                  <i class="far nav-icon fa-circle"></i>
                  <p>Data Banner Promo</p>
                </a>
              </li>
              <li class="nav-item">
              ...
              <li class="nav-item">
                <a href="/admin/fitur" class="nav-link ">
                  <i class="far nav-icon fa-circle"></i>
                  <p>Data Fitur</p>
                </a>
              </li>
          ...
          <div class="col-lg-12">
            <div class="card card-primary card-outline">
              <div class="card-header">
                <h5 class="m-0">@yield('sub-title')</h5>
              </div>
              <div class="card-body">
                @yield('content')
              </div>
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2014-2021 <a href="">Fisioyuk.io</a>.</strong> All rights reserved.
  </footer>
</div>
<!-- ./wrapper -->
